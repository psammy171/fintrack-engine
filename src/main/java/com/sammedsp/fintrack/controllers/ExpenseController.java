...
public class ExpenseController {
    ...
    @GetMapping
    public ResponseEntity<Page<ExpenseResponseDto>> getUserExpenses(Authentication authentication, @RequestParam(defaultValue = "0") int pageNumber,
        ...
        Page<ExpenseResponseDto> paginatedExpenses = this.expenseService.getExpense(userContext.userId(), pageable);
